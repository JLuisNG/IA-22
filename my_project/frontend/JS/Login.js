...
passwordRecoveryForm.addEventListener("submit", function(e) {
  ...
  const button = this.querySelector(".auth__button");
...
function showError(element, message) {
  ...
  const errorMessage = element.querySelector(".auth__error-message");
  if (errorMessage) {
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const loginButtons = document.querySelectorAll(".auth__button");
  ...
  // Añadir efectos de enfoque para los inputs
...
loginForm.addEventListener("submit", function(event) {
  ...
  if (isValid) {
    ...
    // Efecto de botón
    const loginButton = this.querySelector(".auth__button");
